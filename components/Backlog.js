...
function Backlog() {
  return (
    <>
        <div className="backlog-task flex flex-col lg:w-1/5 w-full">
                    <div className="flex flex-row justify-between ">

                        <h1 className=" flex flex-row font-semibold tracking-wide  "  >Backlog Task <span className="rounded-full py-1 px-2 ml-2 bg-primary2-900 text-orange-500 text-sm" >5</span> </h1>
...
{/* ------------------ card -1 ----------------------- */}
<div className="card flex flex-row flex-wrap w-full justify-between lg:flex-col ">
                    ...
                    <div className="backlog-task-card bg-white mt-5 p-3 rounded shadow h-auto w-full">
                        ...
                        <div className="flex flex-row mt-2 justify-start">
                            ...
                            <span className="bg-primary2-900 py-1 px-2 rounded-full text-vs text-primary-900 mr-1" >Design</span>
                            <span className="bg-orange-100 text-orange-500 py-1 px-2 rounded-full text-vs " >Backlog</span>
                        </div>
...
<div className="backlog-task-card bg-white mt-5 p-3 rounded shadow h-auto w-full">
                        ...
                        <div className="flex flex-row justify-between">
                            <h1 className=" flex flex-row font-semibold tracking-wide  "  >Product Design, Figma, Sketch 
(Software), Prototype </h1>
                            <div className="flex flex-row items-center">
                                <BsFillFileEarmarkCheckFill className=" flex flex-row text-xl text-cyan-500   " /> <span className="text-sm ml-1 font-bold text-cyan-500">4</span>
                            </div>
                        ...
                        <div className="flex flex-row justify-between">
                            ...
                            <div className="flex items-center -space-x-2 overflow-hidden mt-2  px-2">
                                ...
                                <Image src='https://i.postimg.cc/DzdJd2LC/Avatar-6.png' width='40' height='40' className=" inline-block h-7 w-7 rounded-full ring-2 ring-white cursor-pointer" />
                                <Image src='https://i.postimg.cc/28K541Jj/Avatar-3.png' width='40' height='40' className=" inline-block h-7 w-7 rounded-full ring-2 ring-white cursor-pointer" />
...
<div className="backlog-task-card bg-white mt-5 p-3 rounded shadow h-auto w-full">
                        ...
                        <div className="flex flex-row justify-between">
                            <h1 className=" flex flex-row font-semibold tracking-wide  "  >Change email option process </h1>
                            <div className="flex flex-row items-center">
                                <BsFillFileEarmarkCheckFill className=" flex flex-row text-xl text-cyan-500   " /> <span className="text-sm ml-1 font-bold text-cyan-500">4</span>
                            </div>
