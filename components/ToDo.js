    ...
    <>
        <div className="backlog-task flex flex-col lg:w-1/5 w-full my-3">
                    <div className="flex flex-row justify-between ">
                        ...
                        <h1 className=" flex flex-row font-semibold tracking-wide  "  >To Do Tasks <span className="rounded-full py-1 px-2 ml-2 bg-primary2-900 text-purple-800 text-sm" >5</span> </h1>
...
{/* ------------------ card -1 ----------------------- */}
                    ...
                    <div className="backlog-task-card bg-white mt-5 p-3 rounded shadow h-auto w-full">
                        ...
                        <div className="flex flex-row mt-2 justify-start">
                            ...
                            <span className="bg-purple-300 text-purple-800 py-1 px-2 rounded-full text-vs " >To do</span>
                        </div>
...
<div className="backlog-task-card bg-white mt-5 p-3 rounded shadow h-auto w-full">
                        ...
                        <div className="flex flex-row justify-between">
                            <h1 className=" flex flex-row font-semibold tracking-wide  "  >Add authentication pages </h1>
                            <div className="flex flex-row items-center">
                                <BsFillFileEarmarkCheckFill className=" flex flex-row text-xl text-cyan-500   " /> <span className="text-sm ml-1 font-bold text-cyan-500">4</span>
                            </div>
...
<div className="backlog-task-card bg-white mt-5 p-3 rounded shadow h-auto w-full">
                        ...
                        <div className="flex flex-row justify-between">
                            <h1 className=" flex flex-row font-semibold tracking-wide  "  >Profile Page Satructure </h1>
                            <div className="flex flex-row items-center">
                                <BsFillFileEarmarkCheckFill className=" flex flex-row text-xl text-cyan-500   " /> <span className="text-sm ml-1 font-bold text-cyan-500">4</span>
                            </div>
