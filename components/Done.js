    ...
    <>
        <div className="backlog-task flex flex-col lg:w-1/5 w-full my-3">
                    <div className="flex flex-row justify-between ">
                        ...
                        <h1 className=" flex flex-row font-semibold tracking-wide  "  >Done <span className="rounded-full py-1 px-2 ml-2 bg-primary2-900 text-lime-600 text-sm" >5</span> </h1>
...
{/* ------------------ card -1 ----------------------- */}
                    ...
                    <div className="backlog-task-card bg-white mt-5 p-3 rounded shadow h-auto w-full">
                        ...
                        <div className="flex flex-row mt-2 justify-start">
                            ...
                            <span className="bg-lime-100 text-lime-600 py-1 px-2 rounded-full text-vs " >Done</span>
                        </div>
